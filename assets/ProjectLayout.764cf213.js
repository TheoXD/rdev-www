import{c as l,a as m,b,r as o,d as s,e as A,f as T}from"./vendor.31204d28.js";import{$ as f,C as a}from"./CopyText.4ba1af2e.js";/* empty css                                               */const n=l(import.meta.url,{modules:[{module:f,specifier:"../../components/CopyText.svelte"}],hydratedComponents:[a],hoisted:[]}),L=m(import.meta.url,"https://theoxd.github.io");b(async(t,i,r)=>{const d=t.createAstro(L,i,r),{project:e}=d.props,c=[{props:{"data-astro-id":"2T7Y76LA"},children:".Project.astro-2T7Y76LA{width:100%;}.DonateLabel.astro-2T7Y76LA{margin-bottom:0;margin-left:0.6em;}"}];for(const p of c)t.styles.add(p);return o`
